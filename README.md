...
5. [🐛 Калибровка и баги](#-калибровка-и-баги)
...
Если при рисовании маски вы столкнулись со смещением кисти относительно курсора мыши, вы можете вручную скорректировать точность позиционирования. Для этого откройте файл `web/js/trix_loader_ui.js` и настройте переменные калибровки по осям X и Y:
